...
<div class="bx_order_make">
	...
	else
	{
		...
		else
		{
			...
			<div class="bx_ordercart_order_pay_center"><a href="javascript:void();" onClick="submitForm('Y'); return false;" class="btn btn_size-big btn_order btn_primary-color"><?=GetMessage("SOA_TEMPL_BUTTON")?></a></div>
