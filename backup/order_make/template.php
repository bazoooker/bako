...
if ($USER->IsAuthorized()){
	...
	if($arUser['UF_TYPE']==4) {
?>
			$('.authorizedtype, .profile_list').hide();
			$('.loading').hide();
<?
	}
	if($arUser['UF_TYPE']==5) {
...
<div id="orderauth" style="display: none;">
...
?>
			...
			<div class="bx_ordercart_order_pay_center"><a href="javascript:void();" onClick="submitForm('Y'); return false;" class="btn btn_main btn btn_size-big btn_order btn_primary-color"><?=GetMessage("SOA_TEMPL_BUTTON")?></a></div>
