...
<script id="basket-item-template" type="text/html">
				...
				<div class="product-modal" id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">               
                    <div class="product-modal__info">
                        <a class="product-modal__name" href="{{DETAIL_PAGE_URL}}">
                            {{NAME}}
                        </a>
...
<input type="text" class="product-controls-horiz__quant" value="{{QUANTITY}}"
                            ...
                            <span class="product-modal__price" id="basket-item-sum-price-{{ID}}">{{{SUM_PRICE_FORMATED}}}</span>
                            
                        </div>
                    </div>

                    <a href="{{DETAIL_PAGE_URL}}" class="product-modal__img" style="background-image: url({{{IMAGE_URL}}}{{^IMAGE_URL}}/img/no-photo.png{{/IMAGE_URL}});"></a>
                    <span class="basket-item-actions-remove visible-xs" data-entity="basket-item-delete" onclick="delInCart({{ID}})"></span>
                </div>
